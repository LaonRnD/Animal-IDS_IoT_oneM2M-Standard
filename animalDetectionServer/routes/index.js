...
///////////////Parameters/////////////////
var cseUrl = "http://"+ conf.cse.host + ':' + conf.cse.port ;
var aeName = conf.ae.name;
var aeId = conf.ae.id;
var aeIp = conf.ae.host;
var cseName = conf.cse.name;
var aePort = conf.ae.port;
var count = 0;
var sub_aeInfo = [
...
function resetGroup(grName){
	...
	console.log("\n[REQUEST]");
	var method = "DELETE";
	var url= cseUrl+"/Mobius/"+gr_name;//cseUrl = "http://192.168.1.11:7579";
	var requestId = Math.floor(Math.random() * 10000);
